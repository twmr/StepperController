...
class timer_control(object):
    ...
    __repr__ = _swig_repr
    msecs = _swig_property(_wxctb.timer_control_msecs_get, _wxctb.timer_control_msecs_set)
    exitflag = _swig_property(_wxctb.timer_control_exitflag_get, _wxctb.timer_control_exitflag_set)
    stop = _swig_property(_wxctb.timer_control_stop_get, _wxctb.timer_control_stop_set)
